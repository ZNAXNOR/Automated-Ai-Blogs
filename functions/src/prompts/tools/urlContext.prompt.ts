...
MANDATORY STEPS:
1. Use the urlContext tool to retrieve the actual page text from 
    the given URL.
2. Identify the purpose of the page (e.g. sales page, documentation, 
    blog post, comparison guide, etc.).
3. Write a **2–3 sentence factual summary** focused on:
   ...
   - What type of content it contains (tutorial, product info, 
    research, etc.).
